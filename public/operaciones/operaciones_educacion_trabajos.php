...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($accion === 'nueva_clase') {
        ...
        header('Location: operaciones_educacion_trabajos.php?saved=1');
        exit;
    }
...
<style>
  ...
  .header-back a{ font-size:0 !important; }
  .header-back a::before{ font-size:.875rem; }
  .header-back a:first-child::before{ content:"Volver a Educaci\00f3n de cuadros"; }
  .header-back a:last-child::before{ content:"Volver a Operaciones"; }
...
<header class="brand-hero">
  <div class="hero-inner container-main">
    ...
    <div class="header-back">
      <a href="operaciones_educacion_cuadros.php" class="btn btn-outline-light btn-sm" style="font-weight:700; padding:.35rem .9rem;">
        ⬅ Volver a Educación de cuadros
      </a>
      <a href="operaciones.php" class="btn btn-secondary btn-sm" style="font-weight:700; padding:.35rem .9rem;">
        Volver a Áreas
      </a>
    </div>
  </div>

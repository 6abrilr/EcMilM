<?php
// public/s3_educacion_tropa_ciclo2.php — Ciclo II · Educación de la tropa
...
/* Demo Ciclo II */
$ciclo = [
    ['sem'=>'3','fecha'=>'20 Mar','tema'=>'Orientación terrestre','resp'=>'Of S-3','part'=>'Tropa','lugar'=>'Terreno','cumplio'=>'Sí','doc'=>''],
];
...
<head>
<meta charset="utf-8">
<title>S-3 · Educación tropa · Ciclo II · B Com 602</title>
...
<div class="page-wrap">
  <div class="container-main">
    ...
    <div class="section-header">
      <div class="section-kicker">CICLO II</div>
      <div class="section-title">Educación operacional de la tropa · Ciclo II</div>
      <p class="section-sub mb-0">
        Instrucción técnica y táctica de nivel intermedio para la tropa.
      </p>
    </div>
    ...
    <div class="panel">
      <div class="panel-title">Detalle de actividades · Ciclo II</div>
      <div class="panel-sub">Listado de actividades de instrucción intermedia.</div>

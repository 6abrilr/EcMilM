<?php
// public/s3_educacion_tropa_ciclo1.php — Ciclo I · Educación de la tropa
...
/* Modo demo: datos Ciclo I */
$ciclo = [
    ['sem'=>'1','fecha'=>'10 Mar','tema'=>'Marcha táctica básica','resp'=>'Jefe de Curso','part'=>'Tropa','lugar'=>'Campo de instr','cumplio'=>'Sí','doc'=>''],
    ['sem'=>'2','fecha'=>'17 Mar','tema'=>'Primeros auxilios','resp'=>'Enfermero Jefe','part'=>'Tropa','lugar'=>'Aula 2','cumplio'=>'No','doc'=>''],
];
...
<head>
<meta charset="utf-8">
<title>S-3 · Educación tropa · Ciclo I · B Com 602</title>
...
<div class="page-wrap">
  <div class="container-main">
    ...
    <div class="section-header">
      <div class="section-kicker">CICLO I</div>
      <div class="section-title">Educación operacional de la tropa · Ciclo I</div>
      <p class="section-sub mb-0">
        Actividades básicas de instrucción del personal de tropa. Más adelante se puede
        vincular cada actividad con su evidencia (PDF, planillas de asistencia, etc.).
      </p>
    </div>
    ...
    <div class="panel">
      ...
      <div class="kpi-row">
        ...
        <div style="min-width:200px; flex:1;">
          <div class="kpi-desc">
            <?= e($ok) ?> actividades cumplidas sobre <?= e($total) ?> planificadas.
          </div>
    ...
    <div class="panel">
      <div class="panel-title">Detalle de actividades · Ciclo I</div>
      <div class="panel-sub">Listado de actividades de educación básica de la tropa.</div>

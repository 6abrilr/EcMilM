...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-03-2026 a las 17:17:00
...
CREATE TABLE `calendario_diario` (
  ...
  `area_code` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `fecha` date NOT NULL,
  `detalle` text COLLATE utf8mb4_general_ci NOT NULL,
  `creado_por` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(3, 1, 'INF', '2026-03-13', 'Se realizo la busqueda de elementos de informatica del Club Andino', 'ROJAS Gabriel', 156, '2026-03-15 20:18:30', '2026-03-15 20:18:30');
...
CREATE TABLE `calendario_tareas` (
  ...
  `estado` enum('POR_HACER','EN_PROCESO','REALIZADA') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'POR_HACER',
  `prioridad` enum('BAJA','MEDIA','ALTA') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'MEDIA',
  `inicio` datetime DEFAULT NULL,
  `fin` datetime DEFAULT NULL,
  `fecha_vencimiento` date DEFAULT NULL,
  `asignado_a` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_por` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_por_id` int DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
...
(3, 1, 'INF', 'Realizar conexiones de internet en Operaciones', 'Armado de fichas, etiquetado, colocacion de swtich', 'POR_HACER', 'ALTA', '2026-03-16 00:00:00', '2026-03-17 00:00:00', '2026-03-16', 'ST SCD ROJAS Gabriel', 'ROJAS Gabriel', 156, '2026-03-15 20:51:02', '2026-03-15 20:03:38');
...
INSERT INTO `chat_archivos` (`id`, `mensaje_id`, `nombre_original`, `nombre_guardado`, `ruta_relativa`, `mime_type`, `tamano_bytes`, `created_at`) VALUES
(1, 2, 'personal_unidad_20260309_035828.xlsx', '20260309_045922_621c5344ba3e.xlsx', 'storage/unidades/ecmilm/chat/4/2026/03/20260309_045922_621c5344ba3e.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 18172, '2026-03-09 03:59:22'),
(2, 2, 'personal_unidad_20260309_035231.xlsx', '20260309_045922_d6224c6e0062.xlsx', 'storage/unidades/ecmilm/chat/4/2026/03/20260309_045922_d6224c6e0062.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 13793, '2026-03-09 03:59:22');
...
CREATE TABLE `chat_conversaciones` (
  `id` bigint UNSIGNED NOT NULL,
  `unidad_id` int NOT NULL,
  `tipo` enum('general','privado') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'privado',
  `titulo` varchar(120) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `creado_por_personal_id` int DEFAULT NULL,
...
INSERT INTO `chat_conversaciones` (`id`, `unidad_id`, `tipo`, `titulo`, `creado_por_personal_id`, `created_at`, `updated_at`) VALUES
(1, 1, 'general', 'Chat General', NULL, '2026-03-08 23:41:36', '2026-03-09 00:25:12'),
(4, 1, 'privado', 'Mis notas', 156, '2026-03-09 00:22:32', '2026-03-09 21:07:51'),
(5, 1, 'privado', NULL, 156, '2026-03-09 01:16:39', '2026-03-09 01:16:43'),
(6, 1, 'privado', NULL, 156, '2026-03-09 12:00:19', '2026-03-09 12:00:22');
...
INSERT INTO `chat_mensajes` (`id`, `conversacion_id`, `personal_id`, `mensaje`, `created_at`) VALUES
(2, 4, 156, '', '2026-03-09 00:59:22'),
(3, 5, 156, 'Hola', '2026-03-09 01:16:43'),
(4, 4, 156, 'tengo que ir a operaciones', '2026-03-09 01:17:18'),
(5, 6, 156, 'hola', '2026-03-09 12:00:22'),
(6, 4, 156, 'enviar mm dgcicd', '2026-03-09 21:07:51');
...
INSERT INTO `chat_participantes` (`id`, `conversacion_id`, `personal_id`, `joined_at`) VALUES
(5, 4, 156, '2026-03-09 00:22:32'),
(6, 5, 156, '2026-03-09 01:16:39'),
(7, 5, 164, '2026-03-09 01:16:39'),
(8, 6, 156, '2026-03-09 12:00:19'),
(9, 6, 483, '2026-03-09 12:00:19');
...
CREATE TABLE `checklist` (
  `id` int NOT NULL,
  `unidad_id` int NOT NULL,
  `file_rel` varchar(512) COLLATE utf8mb4_general_ci NOT NULL,
  `row_idx` int NOT NULL,
  `estado` enum('si','no') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `observacion` text COLLATE utf8mb4_general_ci,
  `evidencia_path` text COLLATE utf8mb4_general_ci,
  `updated_at` timestamp NULL DEFAULT NULL,
  `caracter` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `educacion_tropa_actividades` (
  ...
  `sem` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `fecha` date DEFAULT NULL,
  `tema` varchar(200) COLLATE utf8mb4_general_ci NOT NULL,
  `responsable` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `participantes` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `lugar` varchar(200) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `cumplio` tinyint(1) NOT NULL DEFAULT '0',
  `doc` varchar(255) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `inf_dispositivo_detalle` (
  `id` int NOT NULL,
  `red_dispositivo_id` int NOT NULL,
  `unidad_id` int NOT NULL,
  `estado_id` int DEFAULT NULL,
  `etiqueta` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `hostname` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fabricante` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `modelo` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `serial` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `inventario` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `so` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `firmware` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `edificio_id` int DEFAULT NULL,
  `piso_id` int DEFAULT NULL,
  `oficina_id` int DEFAULT NULL,
  `asignado_personal_id` int DEFAULT NULL,
  `nota` text COLLATE utf8mb4_general_ci,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `inf_redes` (
  ...
  `unidad_id` int NOT NULL,
  `nombre` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `vlan` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cidr` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gateway` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dns` varchar(180) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `it_activos` (
  `id` int NOT NULL,
  `unidad_id` int NOT NULL,
  `tipo` enum('pc','camara','herramienta','mueble','insumo','otro') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'otro',
  `etiqueta` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `descripcion` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `marca` varchar(190) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `modelo` varchar(190) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nro_serie` varchar(190) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `estado` enum('operativo','mantenimiento','baja','roto','prestamo') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'operativo',
  `condicion` enum('activo','deposito') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'activo',
  `edificio_id` int DEFAULT NULL,
  `area_id` int DEFAULT NULL,
  `ubicacion_detalle` varchar(190) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `asignado_personal_id` int DEFAULT NULL,
  `fuente_fondos_id` int DEFAULT NULL,
  `fecha_alta` date DEFAULT NULL,
  `observaciones` text COLLATE utf8mb4_general_ci,
  `creado_en` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `dispositivo_tipo` enum('PC','NOTEBOOK','SERVIDOR','IMPRESORA','MODEM','ROUTER','SWITCH','AP','OTRO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `equipo_nombre` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `usuario_asignado` varchar(160) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sistema_operativo` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `antivirus` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `office_version` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `serial_windows` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cpu` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ram_gb` decimal(6,2) DEFAULT NULL,
  `disco_tipo` enum('HDD','SSD','NVME','EMMC','OTRO') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `disco_gb` int DEFAULT NULL,
  `monitor` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `perifericos` text COLLATE utf8mb4_general_ci,
  `mac` varchar(32) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ip` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ip_gateway` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dns1` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dns2` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `switch_puerto` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `patchera_puerto` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sector_red` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `vlan` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ip_fija` tinyint(1) NOT NULL DEFAULT '0',
  `categoria` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'informatica'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `it_edificios` (
  ...
  `nombre` varchar(190) COLLATE utf8mb4_general_ci NOT NULL,
  `descripcion` text COLLATE utf8mb4_general_ci,
  `ip_rango_desde` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ip_rango_hasta` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_en` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `it_internet` (
  ...
  `proveedor` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `servicio` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `plan` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `velocidad` varchar(80) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `costo` decimal(12,2) DEFAULT NULL,
  `ip_publica` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nota` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `it_mantenimientos` (
  ...
  `fecha` date NOT NULL,
  `tipo` varchar(80) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'preventivo',
  `detalle` text COLLATE utf8mb4_general_ci NOT NULL,
  `realizado_por` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `costo` decimal(12,2) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Estructura de tabla para la tabla `personal_ciclos`
--

CREATE TABLE `personal_ciclos` (
  `id` int NOT NULL,
  `unidad_id` int NOT NULL,
  `ciclo` year NOT NULL,
  `personal_id` int NOT NULL,
  `estado` enum('activo','baja','egreso','licencia_ext') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'activo',
  `nota` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `created_by_id` int DEFAULT NULL
...
--
-- Volcado de datos para la tabla `personal_documentos`
--

INSERT INTO `personal_documentos` (`id`, `unidad_id`, `personal_id`, `sanidad_id`, `evento_id`, `tipo`, `titulo`, `original_name`, `mime`, `bytes`, `sha256`, `path`, `nota`, `fecha`, `created_at`, `deleted_at`, `created_by_id`) VALUES
(8, 1, 156, NULL, NULL, 'foto_perfil', 'Foto 4x4', 'sinfoto.png', 'image/png', 63086, '0f52fcf1bf58d8562d5ce6fa227f1a3350cb14e1fc2ba08c3786cc946458faf6', 'storage/unidades/ecmilm/personal_docs/156/1773613515_sinfoto.png', NULL, '2026-03-15', '2026-03-15 22:25:15', '2026-03-15 22:40:08', 156),
(9, 1, 156, NULL, NULL, 'foto_perfil', 'Foto 4x4', 'sinfoto.png', 'image/png', 63086, '0f52fcf1bf58d8562d5ce6fa227f1a3350cb14e1fc2ba08c3786cc946458faf6', 'storage/unidades/ecmilm/personal_docs/156/1773614468_sinfoto.png', NULL, '2026-03-15', '2026-03-15 22:41:08', '2026-03-15 22:48:04', 156),
(10, 1, 156, NULL, NULL, 'foto_perfil', 'ROJAS_GABRIEL_20260315_156.png', 'sinfoto.png', 'image/png', 63086, '0f52fcf1bf58d8562d5ce6fa227f1a3350cb14e1fc2ba08c3786cc946458faf6', 'storage/unidades/ecmilm/PERSONAL/fotos/ROJAS_GABRIEL_20260315_156.png', NULL, '2026-03-15', '2026-03-15 22:51:52', NULL, 156);
...
CREATE TABLE `personal_eventos` (
  ...
  `unidad_id` int NOT NULL,
  `personal_id` int NOT NULL,
  `tipo` varchar(60) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `personal_unidad` (
  ...
  `cuil` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `estado_civil` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `hijos` int DEFAULT NULL,
  `nou` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nro_cta` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cbu` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `alias_banco` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `jerarquia` enum('OFICIAL','SUBOFICIAL','SOLDADO','AGENTE_CIVIL') COLLATE utf8mb4_general_ci DEFAULT NULL,
  `grado` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `arma` varchar(60) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido_nombre` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apellido` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nombre` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `destino_id` int DEFAULT NULL,
  `funcion` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(156, 1, '41742406', NULL, NULL, NULL, NULL, 'M', 'Vice Almirante John Oconnor 1068, Bariloche, Argentina', 'Soltero', 0, NULL, NULL, NULL, NULL, NULL, 0, '2026-12-31', '2027-01-01', 0, 'Informatica', NULL, 1.00, '2', 'OFICIAL', 'ST', 'SCD', 'ROJAS Gabriel', 'ROJAS', 'NESTOR GABRIEL', 7, NULL, NULL, NULL, NULL, NULL, 1, '2026-02-26 01:25:45', '2026-03-09 02:59:14', 156, '{\"jerarquia\": \"OFICIAL\", \"jerarquia_label\": \"OFICIALES\"}'),
...
(465, 1, '23224707', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CR', 'I', 'GARCIA SOLORZANO Nestor Ignacio', 'GARCIA SOLORZANO', 'Nestor Ignacio', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(466, 1, '23507920', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TC', 'I', 'RAPETTI Martin Maximiliano', 'RAPETTI', 'Martin Maximiliano', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(467, 1, '26436479', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TC', 'I', 'VILLARRUEL Ruben Natalio', 'VILLARRUEL', 'Ruben Natalio', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(468, 1, '21805704', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TC', 'I(dc)', 'KUNTZLER Mario Cristian', 'KUNTZLER', 'Mario Cristian', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(469, 1, '27899445', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TC', 'I', 'GONZALEZ Hernan Ismael', 'GONZALEZ', 'Hernan Ismael', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(470, 1, '28204684', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'MY', 'Aud', 'MORENO Andres Osvaldo', 'MORENO', 'Andres Osvaldo', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(471, 1, '30164946', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'MY', 'Int', 'FOURNIER Natalia Paola', 'FOURNIER', 'Natalia Paola', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(472, 1, '27761939', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'MY', 'VET', 'DIAZ Andrea Veronica', 'DIAZ', 'Andrea Veronica', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(473, 1, '30695928', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'I', 'GARROFE Sebastian Dario', 'GARROFE', 'Sebastian Dario', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(474, 1, '30882594', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'I', 'GOROSITO PARDO Estanislao Gustavo', 'GOROSITO PARDO', 'Estanislao Gustavo', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(475, 1, '33767788', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'I', 'DE ROSA Juan Manuel', 'DE ROSA', 'Juan Manuel', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(476, 1, '33507135', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'Med', 'COLL Matías', 'COLL', 'Matías', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(477, 1, '34315740', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'C', 'MARIÑO Matias Ezequiel', 'MARIÑO', 'Matias Ezequiel', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(478, 1, '37087925', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'I', 'LEAL Criatian Mario', 'LEAL', 'Criatian Mario', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(479, 1, '35014379', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'I', 'MEDINA Mathias Gonzalo', 'MEDINA', 'Mathias Gonzalo', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(480, 1, '38324246', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'I', 'CHEQUER CHARAN Juan Marcos', 'CHEQUER CHARAN', 'Juan Marcos', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(481, 1, '36803866', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'CT', 'Bioq', 'BUDIB Rosa Mabel', 'BUDIB', 'Rosa Mabel', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(482, 1, '35311578', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TP', 'Enf Prof', 'CAPOZZO Matías Nicolás', 'CAPOZZO', 'Matías Nicolás', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(483, 1, '30387854', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TP', 'Educ Fis', 'GUTIERREZ Damian Marcelo', 'GUTIERREZ', 'Damian Marcelo', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(484, 1, '34326371', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TP', 'Int', 'TOLABA Franco Joel', 'TOLABA', 'Franco Joel', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(485, 1, '38046559', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TP', 'I', 'SALTO Matias Andres', 'SALTO', 'Matias Andres', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(486, 1, '37446590', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TP', 'Ars', 'NIERE Ariel Alberto', 'NIERE', 'Ariel Alberto', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(487, 1, '41366154', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TT', 'I', 'RAMIREZ Pedro Jose', 'RAMIREZ', 'Pedro Jose', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(488, 1, '36607744', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TT', 'Com', 'ARAMAYO Ramon Ismael', 'ARAMAYO', 'Ramon Ismael', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(489, 1, '39197765', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TT', 'Bda', 'TOLEDO Eduardo Martín', 'TOLEDO', 'Eduardo Martín', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL),
(490, 1, '41280020', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'OFICIAL', 'TT', 'I', 'RAFFO Erick', 'RAFFO', 'Erick', NULL, NULL, NULL, NULL, NULL, NULL, 3, '2026-03-09 02:58:11', NULL, NULL, NULL);
...
CREATE TABLE `red_edificios` (
  `id` int NOT NULL,
  `it_edificio_id` int DEFAULT NULL,
...
CREATE TABLE `red_edificio_meta` (
  ...
  `unidad_id` int NOT NULL,
  `edificio_id` int NOT NULL,
  `max_dispositivos` int DEFAULT NULL,
  `ip_desde` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ip_hasta` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nota` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `red_enlaces` (
  ...
  `tipo` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'cable',
  `etiqueta` varchar(120) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `red_oficinas` (
  ...
  `edificio_id` int NOT NULL,
  `nombre` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `codigo` varchar(40) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `destino_id` int DEFAULT NULL,
  `tipo` varchar(30) COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'oficina',
...
CREATE TABLE `red_tipos_dispositivo` (
  `id` int NOT NULL,
  `unidad_id` int NOT NULL,
  `tipo` varchar(64) COLLATE utf8mb4_general_ci NOT NULL,
  `label` varchar(32) COLLATE utf8mb4_general_ci NOT NULL,
  `color` varchar(20) COLLATE utf8mb4_general_ci NOT NULL DEFAULT '#8ecae6',
  `icon_svg` mediumtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `roles_locales` (
  ...
  `dni` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `unidad_id` int DEFAULT NULL,
  `areas_acceso` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `role_id` int DEFAULT NULL,
  `rol_app` enum('admin','usuario') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'usuario',
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ;
...
CREATE TABLE `s3_alocuciones` (
  ...
  `acontecimiento` text COLLATE utf8mb4_general_ci,
  `responsable` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cumplio` enum('','si','no','en_ejecucion') COLLATE utf8mb4_general_ci DEFAULT '',
...
CREATE TABLE `s3_clases` (
  `id` int NOT NULL,
  `semana` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `fecha` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `clase_trabajo` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tema` text COLLATE utf8mb4_general_ci,
  `responsable` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `participantes` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `s3_cursos_regulares` (
  ...
  `participantes` text COLLATE utf8mb4_general_ci,
  `desde` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `hasta` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cumplio` enum('','si','no','en_ejecucion') COLLATE utf8mb4_general_ci DEFAULT 'en_ejecucion',
  `documento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `s3_tiro_ami` (
  ...
  `ejercicio` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `resultado` enum('APROBO','NO_APROBO') COLLATE utf8mb4_general_ci DEFAULT 'NO_APROBO',
  `observaciones` text COLLATE utf8mb4_general_ci,
  `fecha` date DEFAULT NULL,
  `documento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `actualizado_por` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `s3_tiro_ejercicios` (
  ...
  `descripcion` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `participantes` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `resultado` enum('APROBO','NO_APROBO') COLLATE utf8mb4_general_ci DEFAULT 'NO_APROBO',
  `fecha` date DEFAULT NULL,
  `documento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `s3_tiro_municion` (
  `id` int NOT NULL,
  `calibre` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cantidad` int DEFAULT NULL,
  `fecha` date DEFAULT NULL,
  `uso` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `documento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `creado_en` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `actualizado_en` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `actualizado_por` varchar(150) COLLATE utf8mb4_general_ci DEFAULT NULL
...
CREATE TABLE `s3_trabajos_gabinete` (
  ...
  `semana` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tema` text COLLATE utf8mb4_general_ci,
  `responsable_grado` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `responsable_nombre` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cumplio` enum('','si','no','en_ejecucion') COLLATE utf8mb4_general_ci DEFAULT '',
  `documento` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL
...
CREATE TABLE `sanidad_partes_enfermo` (
  ...
  `unidad_id` int NOT NULL,
  `personal_id` int NOT NULL,
  `tiene_parte` enum('si','no') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'no',
  `evento` enum('parte','alta') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'parte',
...
CREATE TABLE `unidades` (
  ...
  `nombre_corto` varchar(120) COLLATE utf8mb4_general_ci NOT NULL,
  `nombre_completo` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `subnombre` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `logo_path` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `escudo_path` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `bg_path` varchar(512) COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `usuario_roles` (
  ...
  `unidad_id` int DEFAULT NULL,
  `destino_id` int DEFAULT NULL,
  `areas_acceso` longtext COLLATE utf8mb4_general_ci,
...
CREATE TABLE `xlsx_prefs` (
  ...
  `col_estado` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `col_obs` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `col_caracter` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `updated_by_id` int DEFAULT NULL,
  `table_fmt` enum('classic','form') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'classic',
  `mode_num_is` enum('title','item') COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'item'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `chat_archivos`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_chat_archivos_mensaje_id` (`mensaje_id`);
...
ALTER TABLE `chat_conversaciones`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_chat_conv_unidad_tipo` (`unidad_id`,`tipo`),
  ADD KEY `idx_chat_conv_updated` (`updated_at`);
...
ALTER TABLE `chat_mensajes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_chat_msg_conv_fecha` (`conversacion_id`,`created_at`),
  ADD KEY `idx_chat_msg_personal` (`personal_id`);
...
ALTER TABLE `chat_participantes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_chat_conv_personal` (`conversacion_id`,`personal_id`),
  ADD KEY `idx_chat_part_personal` (`personal_id`);
...
--
-- Indices de la tabla `personal_ciclos`
--
ALTER TABLE `personal_ciclos`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uk_ciclo_personal` (`unidad_id`,`ciclo`,`personal_id`);
...
--
-- AUTO_INCREMENT de la tabla `personal_ciclos`
--
ALTER TABLE `personal_ciclos`
  MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `chat_archivos`
  ADD CONSTRAINT `fk_chat_archivos_mensaje` FOREIGN KEY (`mensaje_id`) REFERENCES `chat_mensajes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `chat_mensajes`
--
ALTER TABLE `chat_mensajes`
  ADD CONSTRAINT `fk_chat_msg_conv` FOREIGN KEY (`conversacion_id`) REFERENCES `chat_conversaciones` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `chat_participantes`
--
ALTER TABLE `chat_participantes`
  ADD CONSTRAINT `fk_chat_part_conv` FOREIGN KEY (`conversacion_id`) REFERENCES `chat_conversaciones` (`id`) ON DELETE CASCADE;

<?php
// public/s3_educacion_tropa_ciclo3.php — Ciclo III · Educación de la tropa
...
/* Demo Ciclo III */
$ciclo = [
    ['sem'=>'4','fecha'=>'27 Mar','tema'=>'Combate cercano','resp'=>'Instructor Combate','part'=>'Tropa','lugar'=>'Polígono','cumplio'=>'Sí','doc'=>''],
];
...
<head>
<meta charset="utf-8">
<title>S-3 · Educación tropa · Ciclo III · B Com 602</title>
...
<div class="page-wrap">
  <div class="container-main">
    ...
    <div class="section-header">
      <div class="section-kicker">CICLO III</div>
      <div class="section-title">Educación operacional de la tropa · Ciclo III</div>
      <p class="section-sub mb-0">
        Actividades avanzadas de combate e instrucción de campaña para la tropa.
      </p>
    </div>
    ...
    <div class="panel">
      <div class="panel-title">Detalle de actividades · Ciclo III</div>
      <div class="panel-sub">Listado de instrucción avanzada.</div>

...
<div class="page-wrap"><div class="container-main"><div class="section-header"><div class="section-kicker"><span class="sk-text">S-1 · PERSONAL</span></div><div class="section-title">Ingreso y egreso de personal civil</div><p class="section-sub mb-0">Por defecto se muestra el último día cargado del año seleccionado. Podés cambiar a otro día o trabajar por rango. Solo se habilita edición manual cuando falta ingreso/egreso o cuando ambos horarios quedaron iguales.</p></div><?php if ($flashOk !== ''): ?><div class="alert alert-success"><?= e($flashOk) ?></div><?php endif; ?><?php if ($flashErr !== ''): ?><div class="alert alert-danger"><?= e($flashErr) ?></div><?php endif; ?><div class="stats-grid"><div class="stat-card"><div class="stat-label">Año del resumen</div><div class="stat-value"><?= e((string)$selectedYear) ?></div></div><div class="stat-card"><div class="stat-label">Civiles activos en padrón</div><div class="stat-value"><?= e((string)$activeCivilCount) ?></div></div></div>
